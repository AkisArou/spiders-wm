...
pub(crate) struct Atoms {
    ...
    pub(crate) wm_window_role: Atom,
    pub(crate) wm_hints: Atom,
...
impl Atoms {
    pub(crate) fn intern_all<C: Connection>(connection: &C) -> Result<Self> {
        Ok(Self {
            ...
            wm_window_role: intern_atom(connection, b"WM_WINDOW_ROLE")?,
            wm_hints: intern_atom(connection, b"WM_HINTS")?,
            ...
            net_wm_window_type_dialog: intern_atom(connection, b"_NET_WM_WINDOW_TYPE_DIALOG")?,
