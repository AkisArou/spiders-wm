...
export const view_workspace: NumberAction;
export const toggle_view_workspace: NumberAction;
export const assign_workspace: NumberAction;
export const toggle_workspace: NumberAction;
