...
impl BootstrapScenario {
    ...
    pub fn register_layer_surface(
        ...
        self.events.push(BootstrapEvent::RegisterLayerSurface {
            surface_id: surface_id.into(),
            output_id: output_id.into(),
            metadata: crate::topology::LayerSurfaceMetadata {
...
pub use crate::domain_session::{DomainSession, DomainSessionError, DomainUpdate};
...
pub use crate::wm::{WmState, WmStateError};
