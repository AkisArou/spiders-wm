use crate::{BootstrapEvent, StartupRegistration};
...
use crate::topology::{CompositorTopologyState, LayerSurfaceMetadata, SurfaceState, TopologyError};
...
impl<R> CompositorApp<R> {
    ...
    fn inferred_tags_for_workspace(
        ...
        workspace_id
            ...
            .map(|workspace| workspace.active_workspaces.clone())
            .unwrap_or_default()
    }
    ...
    fn backend_window_snapshot(
        ...
        let workspaces = self.inferred_tags_for_workspace(workspace_id.as_ref());
...
mod tests {
    ...
    use crate::LayerSurfaceTier;
    use crate::{LayerExclusiveZone, LayerKeyboardInteractivity};
    use spiders_config::authoring_layout::AuthoringLayoutService;
    ...
    fn app_applies_backend_agnostic_bootstrap_events() {
        ...
        app.apply_bootstrap_event(BootstrapEvent::RegisterLayerSurface {
            ...
            metadata: LayerSurfaceMetadata {
                ...
                tier: crate::LayerSurfaceTier::Background,
                keyboard_interactivity: crate::LayerKeyboardInteractivity::None,
                exclusive_zone: crate::LayerExclusiveZone::Neutral,
            },
        })
        .unwrap();
