    ...
    fn controller_preserves_layer_output_for_popup_parented_to_layer_surface() {
        ...
        controller
            .apply_discovery_event(BackendDiscoveryEvent::LayerSurfaceDiscovered {
                ...
                output_id: OutputId::from("out-1"),
                metadata: crate::LayerSurfaceMetadata {
                    namespace: "panel".into(),
                    tier: crate::LayerSurfaceTier::Top,
                    keyboard_interactivity: crate::LayerKeyboardInteractivity::OnDemand,
                    exclusive_zone: crate::LayerExclusiveZone::Exclusive(24),
                },
            })
            .unwrap();
        controller
