use crate::stylo_adapter::{selector_matches_element, LayoutDomTree};
...
pub fn compute_style(
    sheet: &super::compiled::CompiledStyleSheet,
    node: &ResolvedLayoutNode,
) -> Result<ComputedStyle, CssValueError> {
    let mut style = ComputedStyle::default();

    for rule in matching_rules(sheet, node) {
...
pub fn selector_matches(
    selector: &selectors::parser::SelectorList<crate::stylo_adapter::LayoutSelectorImpl>,
    node: &ResolvedLayoutNode,
) -> bool {
