use crate::{
    ...
    config::{ConfigRuntimeState, ConfigSource, LayoutTreeSource},
    layout::LayoutState,
...
impl AppState {
    ...
    pub fn apply_prepared_layout_evaluation(
        &mut self,
        evaluation: PreparedLayoutEvaluation,
        source: LayoutTreeSource,
    ) {
        self.config_runtime.install_layout_tree(
            evaluation.artifact.selected.name,
            evaluation.layout,
            source,
        );
    }
...
mod tests {
    ...
    use super::*;
    use crate::config::{built_in_default_config, LayoutTreeSource};
    use spiders_shared::{
    ...
    fn apply_prepared_layout_evaluation_installs_layout_tree() {
        ...
        app.apply_prepared_layout_evaluation(
            PreparedLayoutEvaluation {
